            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    <div className="w-full lg:w-1/2">
                        <div className="relative bg-gradient-to-b from-gray-200 to-gray-50 rounded-3xl overflow-hidden mb-4 md:mb-6 h-95 sm:h-80 md:h-96 lg:h-[565px] lg:w-[524px] ">
                                ...
                                <div className="flex gap-1 w-full">
                                    {images.map((_, index) => (
                                        <button
                                            ...
                                            className={`h-1 rounded-full transition-all duration-300 flex-1 ${index === currentImageIndex ? 'bg-white' : 'bg-[#D4D4D4]'
                                                }`}
                                        ></button>
                                    ))}
                                </div>
